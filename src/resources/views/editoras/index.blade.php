...
<div class="card">
    ...
    <div class="card-body">
        ...
        <br>
        <table class="table table-bordered table-striped dataTable dtr-inline" id="editora-table" style="font-size: 13px;">
            <thead>
                <tr>
            ...
            },
            {
                ...
                render: function (data) {
                    if (data == 1) {
                        ...
                        return '<span class="badge badge-primary">Estrangeira</span>';
                    }
                    else {
                        return data;
                    }
